...
class ViewerLL:
    ...
    def getGameFinished():
        ...
        for game in games:
            if games[game][4] != None:
                gamesfinished.append([games[game][0], games[game][1], games[game][3], games[game][4], games[game][5], games[game][6]])
    ...
    def getUpcomingGames():
        ...
        for game in games:
            if games[game][4] == None:
                gamesupcoming.append([games[game][0],games[game][1],games[game][3]])
                """ Team 1, Team 2, Date"""
